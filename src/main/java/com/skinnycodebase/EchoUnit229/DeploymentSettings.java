...
public class DeploymentSettings {
    ...
    public static String BOT_AUTH_TOKEN = System.getenv("DISCORD_UNIT229_TOKEN");

    public static String BOIS_ROLE_ID = System.getenv("BOIS_ROLE_ID");

    public static String LFGBOT_CHANNEL_ID = System.getenv("LFGBOT_ID");
